								...
								<div id="form_details" class="hideme" >
									<div class="dis-table" >
										<form id="FormCS" class="col s12 gb_arrow_box whiteform contract form-detais">
											<p class="gb_textcs_x1 font-form" >I would like to receive information about the sculpture:</p>
											<div class="row">
												<div class="col s12">
													<div class="col s12 l4">
														<input id="name" class="border_cs" type="text" name="name" required placeholder="NAME">
													</div>
													<div class="col s12 l4">
														<input id="email" class="border_cs" type="email" name="email" required placeholder="E-MAIL">
													</div>
													<div class="col s12 l4">
														<input id="city" class="border_cs" type="text" name="city" required placeholder="CITY">
													</div>
												</div>
												<div class="col s12">
													<div class="col s12 l8">
														<textarea id="comment" style="height: 80px;" class="border_cs" maxlength="200" name="comment" rows=5 required placeholder="COMMENTS"></textarea>
													</div>
													<div class="col s12 l4">
														<div id="progressdiv" class="progress hide"><div class="indeterminate"></div></div>
														<a id="sendBtn" class="btn btn-small col s12 green waves-effect margin-top-13 gb_noboxshadow">CONTACT ME</a>
													</div>
												</div>
											</div>
										</form>
