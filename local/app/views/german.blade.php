    ...
    <div id="">
        <div class="bg_bottom">
            <div class="section" style="padding: 0 0 40px 0;">
                <div class="container fontCrimson">
                    <div class="row center">
                        <p class="itaBold" style="font-size: 2.5rem; line-height: 100%;">"Soy un apasionado de la vida, del amor y todo lo que me rodea. Siempre estoy en búsqueda de situaciones y sé que todo lo que está afuera, en la naturaleza, es parte de mí<br/><br/>
