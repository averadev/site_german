...
<html>
  <head>
    ...
    <title>German Arzate | Próximamente</title>
    <!-- CSS  -->
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <p>mientras tanto te invito a que visites mi <a href="{{ URL::to('/') }}">página web</a> y te enteres de mis proximas subastas o bien puedes ir directamente haciendo clic en el siguiente botón.</p>
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tbody>
                                                            <tr>
                                                                <td><a href="{{ URL::to('subasta/subastas#tab6') }}" target="_blank">Ir a subastas</a></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </td>
                                            ...
                                            <br>
                                            <p>Atentamente</p>
                                            <a href="{{ URL::to('/') }}"><img src="{{ URL::asset('/../media/img/logo.png') }}" width="165px" alt="German Arzate"></a>
