							...
							<div class="tab-content tab-bg-color" style="margin-top: 2px;">
								...
								<div class="tab-pane" id="profile-v"> <!--Tab ofertas -->
									<div class="row no-margin-bottom">
										<div style="min-height: 340px; margin-left: 5px;" class="tab-space">
											@if( count($auction)>0 )
												...
												<label>Últimas ofertas:</label>
													...
													@foreach($bids as $bid)
														<li class="collection-item avatar">
															<i class="material-icons circle grey darken-1 md-24">account_box</i>
															<span class="title">{{$bid->nick}}</span>
															<p class="bid-amount"><span class="bidlabel">Oferta:</span> ${{$bid->amount}}</p>
														</li>
													@endforeach
													</ul>
												</div>
