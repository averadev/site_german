		...
		<div class="section">
			<div class="row"  style="margin-bottom: 0em;">
				...
				<div class="col l10 s12 margin-bottom margin-text center-align">
					<a href="{{ url('/subasta/subastas#tab6') }}" class="waves-effect grey center-align lighten-5 grey-border btn"><i class="material-icons right">navigate_next</i>Regresar</a>
				</div>
			</div>
		</div>
	</div>
