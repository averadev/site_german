	...
	<div class="container">
		<div class="section">
			<div class="row"  style="margin-bottom: 0em;">
				<div class="col s12">
					<ul id="monumentaltabs" class="tabs black-tabs">
			...
			<div class="section" >
				<div class="row">
					...
					<div class="hide-on-large-only">
						<img style="width: 30%; margin-left: 35%; margin-top: 5%;" src="../media/img/monumental/monpic1.png" alt="escultura1">
					</div>					
				</div>
				<div class="row" >
					<div class="col l10 m12 s12 offset-l1 ">
						...
						<div class="hide-on-med-and-down" style="position: relative; margin-bottom: 65%;">
							<img style="width: 65%; position: absolute; top:5em; left:-3em; z-index: 100; " src="../media/img/monumental/monpic2.png" alt="escultura1">
						</div>
						<div class="hide-on-large-only">
							<img style="width: 80%; margin-left: 10%; margin-top: 10%;" src="../media/img/monumental/monpic2.png" alt="escultura1">
						</div>		
						...
						<div class="hide-on-med-and-down" style="position: relative; margin-bottom: 28%;">
							<img style="width: 75%; position: absolute; top:-12.5em; right:0em; z-index: 100; " src="../media/img/monumental/monpic3.png" alt="escultura1">
						</div>
						<div class="hide-on-large-only">
							<img style="width: 80%; margin-left: 10%; margin-top: 10%;" src="../media/img/monumental/monpic3.png" alt="escultura1">
						</div>												
						<div class="right">
							...
							<div class="hide-on-med-and-down" style="position: relative; margin-bottom: 40em;">
								<img style="width: 70%; position: absolute; top:6em; left:-3em; z-index: 100; " src="../media/img/monumental/monpic4.png" alt="escultura1">
							</div>
							<div class="hide-on-large-only">
								<img style="width: 80%; margin-left: 10%; margin-top: 10%;" src="../media/img/monumental/monpic4.png" alt="escultura1">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="section" >
					<div class="row">
						<div class="col s12 center">
							<h3 style="padding-top: 13vw; padding-bottom: 12vw; " class="header white-text col s12 light">Majestuosidad</h3>
						</div>
					</div>
					<div class="row">
