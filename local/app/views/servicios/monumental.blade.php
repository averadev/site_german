						...
						<div id="divform" class="row">
							<div class="col s12 m12 l8 offset-l2 bg-white">	
								...
								<form id="form_appt" class="whiteform col s12 m12 l10 offset-l1" >
									...
									<input name="name" required type="text" maxlength="50" placeholder="Nombre Completo">
									<input name="email" required type="text" maxlength="50" placeholder="Correo electrónico">
									<input name="company"  required type="text" maxlength="50" placeholder="Compañía / Empresa">
									<input name="date" class="datepicker" required type="text" placeholder="Día para la cita">
									<textarea name="comment" maxlength="250"  cols="100" style="height: 100px" placeholder="Comentarios" ></textarea>							
