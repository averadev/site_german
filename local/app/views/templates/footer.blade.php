			...
			<div class="row">
				<div class="col l4 s12">
					<ul class="footer-info">
						...
						<li style="margin-top: 1em;" >SÍGUEME EN: 
						<a href="#!" target="_blank"><img class="social-button" alt="facebook" id="goface" src="{{ URL::asset('media/img/home/fb.png') }}"></a>
						<a href="#!" target="_blank"><img class="social-button" alt="instagram" id="goinsta" src="{{ URL::asset('media/img/home/insta.png') }}"></a>
						<a href="#!" target="_blank"><img class="social-button" alt="twitter" id="gotwitter" src="{{ URL::asset('media/img/home/twitter.png') }}"></a></li>
					</ul>
				</div>
				<div class="col l4 s12">
					<div class="row">
				...
				<div class="col l4 s12">
					<ul class="adress-info">
						<img style="width: 7em; margin-bottom: 20px;" src="{{ URL::asset('media/img/home/logoblanco.png') }}" alt="logo footer German Arzate">
