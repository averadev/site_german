				...
				<div class="col s12">
					<nav id="navigation-menu" class="white">
						<ul class="tabs-menu menuFont">
							...
							<li class="tab"><a class="active" id="interiores" href="interiores" >INTERIOR SCULPTURES</a></li>
						</ul>
					</nav>
				</div>				
			</div>
			...
			<div id="index-banner" class="parallax-container">
				<div class="section no-pad-bot">
					...
					<!--	<h1 class="header center teal-text text-lighten-2">Parallax Template</h1> -->
						...
						<div class="row center">
							<a style="margin-top: 1%;" class="appointment waves-effect transparent lighten-5 white-border noshadow btn">Make an appointment</a>
						</div>
						<br><br>
					</div>
				</div>
						...
						<div id="divform" class="row">
							<div class="col s12 m12 l8 offset-l2 bg-white">		
								...
								<form class="whiteform col s12 m12 l10 offset-l1" id="form_appt">							
									...
									<input name="company" required type="text" placeholder="Company">
									<input name="date" class="datepicker" required type="text" placeholder="Meeting date">
									<textarea  name="comment" cols="100" style="height: 100px" placeholder="Comments" ></textarea>							
