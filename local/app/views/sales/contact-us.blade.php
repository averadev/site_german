			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col s12 m12 l6 fontCrimson">
						<div class="center-align">
							<a href="https://www.facebook.com/GermanArzateSculptor/" target="_blank" style="color:#fff; margin-right: 25px;"><img class="responsive-img" src="{{ URL::asset('media/img/facebook.svg') }}" width="45" style="margin-right: 25px; vertical-align: middle;"> Facebook</a>
							<a href="https://twitter.com/germanarzate" target="_blank" style="color: #fff;"><img class="responsive-img" src="{{ URL::asset('media/img/twitter.svg') }}" width="45" style="margin-right: 25px; vertical-align: middle;"> Twitter</a>
						</div>
					</div>
					<div class="col s12 m12 l3"></div>
				</div>
				<div class="row">
					<div class="col s12 m12 l6 center-align" style="position: absolute; bottom: 0; right: 0; background: #12161a;">
