			...
			<div class="row">
				<div class="col l4 s12">
					<ul class="footer-info" >
						...
						<li><a href="{{ url('/subasta') }}">AUCTION</a></li>
						<li><a href="{{ url('servicios/monumental') }}">SPECIAL WORKS</a></li>
						<li><a target=target="_blank" href='{{ substr(url(), 0, -3)."/blog/en/" }}'>PRESS RELEASES</a></li>
				...
				<div class="col l4 s12">
					<div class="row">
						<div class="col s12">
							<p style="margin-bottom: 1em; font-size: 14px; letter-spacing: 1px;" class="footer-color"> ¡SUBSCRIBE TO THE NEWSLETTER! </p>
						</div>
						<form class="myform col s11 l9 center" id="newsletter_form">
							<span id="newslettererror" class="hide" > Please fill all fields.</span>											
							<input class="my-input" id="my-name-letter" name="my-name-letter" required type="text" placeholder="Name">
							<input class="my-input" id="my-email-letter" name="my-email-letter" required type="text" placeholder="E-mail">
							<div id="progressLetter" class="progress hide"><div class="indeterminate"></div></div>
							<a id="newsletterSend" style="font-size: 0.8rem; font-weight: bold; letter-spacing: 1px;  " class="waves-effect footer-color white-border grey darken-3 waves-light btn">SIGN UP</a>
						</form>	
