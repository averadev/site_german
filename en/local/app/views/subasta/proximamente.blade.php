						...
						<div class="row">
							...
							<div class="col s12 m12 l12 margin-top-20">
								<div class="row">
									<div class="col s12">
										@foreach ($date_coming as $key=> $value)
										<p style="text-align: center;" class="light text-proxim">The next sculpture's development <br> will start it's transmission <br> on {{$value->NombreMes}} {{$value->Dia}}, {{$value->Anio}}, <br> and you can follow it here.</p>
										@endforeach
									</div>
								</div>
									<div class="row">
									<div style="">
										<form style="padding-bottom: 12px;" id="FormProx" class="col s12 gb_arrow_box whiteform contract">
											<p class="gb_textcs_x1" style="margin: 3px 0 5px 10px;">I would like to receive information about the sculpture:</p>
											<div class="row no-margin-bottom">
												<div class="col s12">
													<div class="col s12 l4">
														<input id="nameProx" class="border_cs" type="text" name="name" required placeholder="NAME">
													</div>
													<div class="col s12 l4">
														<input id="emailProx" class="border_cs" type="email" name="email" required placeholder="E-MAIL">
													</div>
													<div class="col s12 l4">
														<input id="cityProx" class="border_cs" type="text" name="city" required placeholder="CITY">
													</div>
												</div>
												<div class="col s12">
													<div class="col s12 l8">
														<textarea id="commentProx" style="height: 80px;" class="border_cs" maxlength="200" name="comment" rows=5 required placeholder="COMMENTS"></textarea>
													</div>
													<div class="col s12 l4">
														<div id="progressdivProx" class="progress hide"><div class="indeterminate"></div></div>
														<a id="sendBtnProx" class="btn btn-small col s12 green waves-effect margin-top-13 gb_noboxshadow">CONTACT ME</a>
													</div>
												</div>
											</div>
										</form>
